...
class Card extends React.Component {
    ...
    render() {
        const {title, backgroundImage, data, voteAverage, voteCount, description, genre} = this.props;
        return (
            <div className="card">
                ...
                <div className="card-info">
                    ...
                    <button className="card-info__hideButton" onClick={this.toogleDescription}>Toogle Description
                    </button>
